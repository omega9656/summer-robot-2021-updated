...
@Autonomous(name = "AutoCV", group = "Concept")
public class AutoConCV extends LinearOpMode{
    ElapsedTime time;
...
/*
                    ...
                    if (updatedRecognitions != null) {
                        ...
                        if (updatedRecognitions.size() == 0){
                            ...
                            for (Recognition recognition : updatedRecognitions) {
                                ...
                                if (recognition.getLeft() < 200 && recognition.getLabel().equals("Duck")) {
                                    telemetry.addData("LEFT", "!");
                                } else if (recognition.getRight() > 400 && recognition.getLabel().equals("Duck")) {
        ...
        private void initVuforia () {
            ...
            parameters.minWebcamAspectRatio = 720.0 / 480.0;
